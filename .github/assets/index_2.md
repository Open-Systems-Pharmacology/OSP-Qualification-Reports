...
Each report includes specific citation information. In general, please cite the Open Systems Pharmacology project and the specific qualification report. Additional details can be found on the [Open Systems Pharmacology website](https://www.open-systems-pharmacology.org/).
...
Both tools are free and open-source, available at [www.open-systems-pharmacology.org](https://www.open-systems-pharmacology.org/).
